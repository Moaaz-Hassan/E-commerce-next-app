...
import { RegisterSchema } from "@/app/_schema/AuthenticationSchema";
import { useForm } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import { Signup } from "@/app/_services/AuthenticationServices";
      ...
      <div className=" min-w-md bg-white py-10 px-6 rounded-2xl shadow-2xl">
        ...
        <form onSubmit={handleSubmit(signUp)} className=" flex flex-col gap-4">
          ...
          <Input
            ...
            isInvalid={formState.errors.phone?.message ? true : false}
          ...
          <p>
            If you have an account to please{" "}
            <Link href={"/login"} className=" text-blue-500 pl-1">
              signIn
            </Link>
          </p>
        </form>
